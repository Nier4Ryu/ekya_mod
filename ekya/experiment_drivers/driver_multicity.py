...
if __name__ == "__main__":
    ...
    scheduler_kwargs = {"default_hyperparams": params}
    if scheduler_name.lower() == "fair":
        ...
        # Set the files to read
        scheduler_kwargs = {"profile_hyperparam": params}
        ...
        scheduler_kwargs = {
            ...
            "microprofile_resources_per_trial": args[
                "microprofile_resources_per_trial"
            ],
            "microprofile_epochs": args["microprofile_epochs"],
            "microprofile_subsample_rate": args["microprofile_subsample_rate"],
            "profiling_epochs": [
                int(x) for x in args["microprofile_profiling_epochs"].split(",")
            ],
            "default_hyperparams": params,
